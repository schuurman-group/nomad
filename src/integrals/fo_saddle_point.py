...
import src.integrals.nuclear_guassian as nuc_ints
...
def traj_overlap(traj1, traj2, nuc_only=True, Snuc=False):
    """ Returns < Psi | Psi' >, the overlap integral of two trajectories"""
    return s_integral(tddraj1, traj2, nuc_only, Snuc)

# returns total overlap of trajectory basis function
def s_integral(traj1, traj2, nuc_only=True Snuc=None):
